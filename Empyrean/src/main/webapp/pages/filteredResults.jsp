...
<body>
	...
	<c:if test="${empty filteredProducts}">
		<h1>No products found within this category</h1> 
	</c:if>
	
	
	<!-- probable way of doing the filtering, to compile all of our results within a single section, ali jhaayou less bhaedinchha -->
		 ...
		 <div class="product">
				...
				<c:forEach var="products" items="${filteredProducts}">
					 ...
					 <form action="${pageContext.request.contextPath}/AddToCartServlet" method="post">
						...
						<figure>
				            <img src="http://localhost:8082/images/products/${products.image_link}" alt="${products.productName}">
				           	<figcaption>
								${products.productName}	 <br>
				            	$${products.productPrice}
		            			<div class = "cartDiv">
			            			<button type="submit" class="addToCart" value="${products.productID}" name="toCart">
	...
	<!-- alternative way of presenting, headers need to be improved for each filtering, jhaayouu kaam chha -->
